<div class="container" id="manage_link_prefixes_page">
    <section class="page-title-section">
        <div class="page-title">
            <ol class="breadcrumb pull-right">
                <li><a href="/">Home</a></li>
                <li><a href="/">Link Prefixes</a></li>
                <li class="active">Manage</li>
            </ol>
            <h4>Manage Link Prefixes</h4>
        </div>
    </section>
    <section>
        <p>
        ...
        <a href="/adminLinkPrefix/create" class="btn-green">Create A New Link Prefix</a>
    </section>
    <section>
